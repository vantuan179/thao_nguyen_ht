		...
		<div class="row no-gutters">
			...
			<nav class="col-md-2 admin-sidebar">
				...
				<a href="${pageContext.request.contextPath}/admin"
					class="nav-link active"> <i class="fas fa-chart-pie"></i> Tổng
					quan <span class="badge">${totalLessons + totalQuizzes}</span>
				</a>

				<div class="nav-section">Quản lý</div>
				<a href="${pageContext.request.contextPath}/admin/grades"
					class="nav-link"> <i class="fas fa-school"></i> Lớp học <span
					class="badge">${totalGrades}</span>
				</a> <a href="${pageContext.request.contextPath}/admin/lessons"
					class="nav-link"> <i class="fas fa-book"></i> Bài học <span
					...
					hỏi <span class="badge">${totalQuizzes}</span>
				</a> <a href="${pageContext.request.contextPath}/admin/users"
					class="nav-link"> <i class="fas fa-users"></i> Người dùng <span
					class="badge">${totalUsers}</span>
				</a>

				<div class="nav-section">Tiện ích</div>
				<a href="${pageContext.request.contextPath}/admin/grades/create"
					class="nav-link"> <i class="fas fa-plus-circle"></i> Thêm lớp
					học
				</a> <a href="${pageContext.request.contextPath}/admin/lessons/add"
					class="nav-link"> <i class="fas fa-plus-circle"></i> Thêm bài
					học
				</a> <a href="${pageContext.request.contextPath}/admin/quizzes/add"
					class="nav-link"> <i class="fas fa-plus-circle"></i> Thêm câu
					hỏi
				</a>
