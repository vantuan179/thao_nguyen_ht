			...
			<div class="col-lg-8">
				<div class="container">
					...
					<div class="hero animate__animated animate__bounceIn">
						...
						<p class="lead mt-3">Học toán thật vui qua những bài học sinh
							động và câu đố thú vị.</p>
									...
									<div class="col-md-6 col-lg-4 mb-4">
										<div class="lesson-card animate__animated animate__fadeInUp"
											...
											<div class="card-body text-center">
												<div class="lesson-icon" style="font-size: 3.5rem;">
													${grade.icon}</div>
												<h4 class="card-title text-info font-weight-bold"
													style="font-size: 1.1rem;">${grade.gradeName}</h4>
												<p class="card-text text-muted"
													style="font-size: 0.85rem; min-height: 40px;">${grade.description}</p>
												<div class="mb-2">
													<span class="badge badge-info" style="font-size: 0.75rem;">
														<i class="fas fa-book"></i> ${grade.lessons != null ? grade.lessons.size() : 0}
														bài học
													</span>
												</div>
												<a
													href="${pageContext.request.contextPath}/grades/${grade.id}"
													class="btn btn-fun btn-fun-success"
													style="font-size: 0.9rem; padding: 8px 20px;"> Vào học
													🎒 </a>
											</div>
										</div>
									</div>
					...
					<div class="row mt-5 mb-4">
						<div class="col-md-4">
							<div class="text-center feature-item p-3">
								...
								<h6 class="mt-2 font-weight-bold">Học mà chơi</h6>
								<p class="text-muted small">Các bài học sinh động, giúp bé
									học toán tự nhiên</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="text-center feature-item p-3">
								...
								<h6 class="mt-2 font-weight-bold">Thử thách bản thân</h6>
								<p class="text-muted small">Nhiều câu đố và bài tập rèn
									luyện tư duy</p>
							</div>
						</div>
						<div class="col-md-4">
							<div class="text-center feature-item p-3">
								<i class="fas fa-chart-line text-success"
									style="font-size: 2rem;"></i>
								<h6 class="mt-2 font-weight-bold">Tiến bộ mỗi ngày</h6>
								<p class="text-muted small">Theo dõi sự tiến bộ qua từng bài
									học</p>
							</div>
						</div>
					</div>
