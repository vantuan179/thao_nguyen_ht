...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom container">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/">🧮 Bé Học Toán</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/lessons">Bài học</a></li>
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/games">Trò chơi</a></li>
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-fun btn-fun-primary text-white px-3" 
