								...
								if (!tickets || tickets.length === 0) {
									...
									tickets
											.forEach(function(ticket) {
												...
												html += '<a href="#" class="chat-ticket-item '
														+ (isUnread ? 'unread'
																: '')
														+ '" data-ticket-id="'
														+ ticket.id
												...
												html += '<span class="ticket-subject">'
														+ ticket.subject
														+ '</span>';
												if (isUnread) {
								...
								$
										.ajax({
											...
											error : function() {
												$('#chatMessages')
														.html(
																'<div class="empty-state"><i class="fas fa-exclamation-triangle"></i> Không thể tải tin nhắn</div>');
											}
										});
							}
