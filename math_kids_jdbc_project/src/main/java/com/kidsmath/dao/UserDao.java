...
public class UserDao {
	...
	public List<User> findAll() {
		String sql = "SELECT id, username, password, full_name, email, role, created_at FROM users ORDER BY id";
	...
	public User findByUsername(String username) {
		String sql = "SELECT id, username, password, full_name, email, role, created_at FROM users WHERE username = ?";
	...
	public int save(User user) {
		...
		return jdbcTemplate.update(sql, user.getUsername(), user.getPassword(), user.getFullName(), user.getEmail(), user.getRole() != null ? user.getRole() : "USER", now);
	}

	public int update(User user) {
		String sql = "UPDATE users SET username = ?, password = ?, full_name = ?, email = ?, role = ? WHERE id = ?";
		return jdbcTemplate.update(sql, user.getUsername(), user.getPassword(), user.getFullName(), user.getEmail(), user.getRole(), user.getId());
	}
